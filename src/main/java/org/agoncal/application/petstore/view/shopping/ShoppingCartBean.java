...
import org.agoncal.application.petstore.util.Loggable;
 ...
 import org.agoncal.application.petstore.proxy.PurchaseOrderProxy;
...
public class ShoppingCartBean extends AbstractBean implements Serializable {
    ...
    private Conversation conversation;
     ...
     private PurchaseOrderProxy orderProxy = new PurchaseOrderProxy();
    ...
    public String confirmOrder() {
    	...
    	for( ShoppingCartItem item :cartItems) {
    		ol.add(new OrderLine(item.getQuantity(), item.getItem()));
    	}
        // order = orderBean.createOrder(getCustomer(), creditCard, ol);
    	 PurchaseOrderDto entity =  new PurchaseOrderDto();
    	 entity.setCustomer(Mapper.Map(getCustomer()));
    	 entity.setCreditCard(Mapper.Map(creditCard));
    	 entity.setOrderLines(Mapper.Map(ol));
    	 order = orderProxy.createOrder(entity);
